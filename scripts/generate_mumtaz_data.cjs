...
const inputCsv = 'C:/Users/ender/OneDrive - Institut Teknologi Sepuluh Nopember/Semester 4/FP/NOTEBOOK-DATAFINAL/DL/KABUPATEN(MUMTAZ)/mumtaz_all_models_deliverable/mumtaz_all_models_predictions_kabupaten.csv';
...
console.log('Successfully generated data_predictions_kabupaten.json with correct Mumtaz data');
